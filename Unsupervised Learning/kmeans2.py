...
dataset = pd.read_csv(url, names=names)#.iloc[1:,:]
...
plt.title('Performance evaluation scores')
plt.grid(True)
plt.savefig('Con con_test1.png')

fig5, ax5 = plt.subplots()
ax5.plot(num_components, var_vals)
plt.title('Variance by cluster count')
plt.xlabel('Number of clusters')
plt.grid(True)
plt.savefig('Con con_test2.png')
...
ax1.plot(list(range(len(pca.explained_variance_ratio_))), cum_var)
...
plt.savefig('Con recon error for pca.png')
...
plt.savefig('Con con_test3b.png')
...
plt.savefig('Con recon error rand.png')
...
plt.axis('tight')
plt.xlabel('n_components')
plt.title('Standard deviation of reconstruction error magnitude')
ax.set_ylabel('Standard Deviation of Reconstruction Error')
plt.savefig('Con Variation in recon error rand.png')  #std of recon error for rp
...
for c in range(3, X_train.shape[1]+1):
    ...
    finalDf = pd.concat([principalDf, dataset[['contraceptive used']]], axis = 1)
...
plt.savefig('Con kmeans and pca acc.png')  #std of recon error for rp
...
plt.title('Performance evaluation scores')
plt.grid(True)
plt.savefig('Con perf km and pca.png')
...
plt.xlabel('components')
plt.grid(True)
plt.savefig('Con var km pca.png')
...
plt.xlabel('components')
plt.grid(True)
plt.savefig('Con rmse km pca.png')
...
plt.title('Performance evaluation scores')
plt.grid(True)
plt.savefig('Con perf em and pca.png')
...
plt.xlabel('components')
plt.grid(True)
plt.savefig('Con var em and pca.png')
...
plt.xlabel('components')
plt.grid(True)
plt.savefig('Con aic em and pca.png')
...
plt.xlabel('components')
plt.grid(True)
plt.savefig('Con rmse em and pca.png')
...
plt.savefig('Con em and pca acc.png')  #std of recon error for rp
...
plt.title('Performance evaluation scores')
plt.grid(True)
plt.savefig('Con perf km and ica.png')
...
plt.xlabel('Number of clusters')
plt.grid(True)
plt.savefig('Con var km and ica.png')
...
plt.xlabel('Number of clusters')
plt.grid(True)
plt.savefig('Con rmse km and ica.png')
...
plt.xlabel('n_components')
ax.set_ylabel('accuracy score')
plt.savefig('Con km and ica acc.png')  #std of recon error for rp
plt.clf()
...
plt.title('Performance evaluation scores')
plt.grid(True)
plt.savefig('Con perf em and ica.png')
...
plt.xlabel('Number of clusters')
plt.grid(True)
plt.savefig('Con var em and ica.png')
...
plt.xlabel('Number of clusters')
plt.grid(True)
plt.savefig('Con aic em and ica.png')
...
plt.xlabel('Number of clusters')
plt.grid(True)
plt.savefig('Con rmse em and ica.png')
...
plt.xlabel('n_components')
ax.set_ylabel('accuracy score')
plt.savefig('Con em and ica acc.png')  #std of recon error for rp
...
plt.title('Performance evaluation scores')
plt.grid(True)
plt.savefig('Con perf km and rand.png')
...
plt.xlabel('Number of clusters')
plt.grid(True)
plt.savefig('Con var km and rand.png')
...
plt.xlabel('Number of clusters')
plt.grid(True)
plt.savefig('Con rmse km and rand.png')
...
plt.xlabel('n_components')
ax.set_ylabel('accuracy score')
plt.savefig('Con km and rand acc.png')  #std of recon error for rp
plt.clf()
...
plt.title('Performance evaluation scores')
plt.grid(True)
plt.savefig('Con perf em and rand.png')
...
plt.xlabel('Number of clusters')
plt.grid(True)
plt.savefig('Con var em and rand.png')
...
plt.xlabel('Number of clusters')
plt.grid(True)
plt.savefig('Con aic em and rand.png')
...
plt.xlabel('Number of clusters')
plt.grid(True)
plt.savefig('Con rmse em and rand.png')
...
plt.xlabel('n_components')
ax.set_ylabel('accuracy score')
plt.savefig('Con em and rand acc.png')  #std of recon error for rp
...
plt.title('Performance evaluation scores')
plt.grid(True)
plt.savefig('Con perf km and lin.png')
...
plt.xlabel('Number of clusters')
plt.grid(True)
plt.savefig('Con var km and lin.png')
...
plt.xlabel('Number of clusters')
plt.grid(True)
plt.savefig('Con rmse km and lin.png')
...
plt.xlabel('n_components')
ax.set_ylabel('accuracy score')
plt.savefig('Con km and lin acc.png')  #std of recon error for rp
plt.clf()
...
plt.title('Performance evaluation scores')
plt.grid(True)
plt.savefig('Con perf em and lin.png')
...
plt.xlabel('Number of clusters')
plt.grid(True)
plt.savefig('Con var em and lin.png')
...
plt.xlabel('Number of clusters')
plt.grid(True)
plt.savefig('Con aic em and lin.png')
...
plt.xlabel('Number of clusters')
plt.grid(True)
plt.savefig('Con rmse em and lin.png')
...
plt.xlabel('n_components')
ax.set_ylabel('accuracy score')
plt.savefig('Con em and lin acc.png')  #std of recon error for rp
...
for c in range (3,10):
    ica.set_params(n_components=c)
    tmp = ica.fit_transform(X_train)
    tmp = pd.DataFrame(tmp)
    tmp = tmp.kurt(axis=0)
    kurtosis_vals.append(tmp.abs().mean())



ax.plot(np.arange(X_Train.shape[1]))
